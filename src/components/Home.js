...
export default function Home() {
  ...
  return (
    <div className="home-container">
      ...
      {/* ⬇️ Always visible content regardless of login status */}
      <div className="charts-container">
        ...
        <div className="text-content">
          ...
          <p>
            Explore your top artists, genres, and tracks across <br />
      ...
      <div className="playlist-container">
        <img src={Playlist} alt="Playlist Logo" className="playlist-logo" />
        <div className="text-content">
          <h4>Create Playlists</h4>
          <p>
            Generate a playlist from your personalized metrics <br />
      ...
      <div className="recentlyPlayed-container">
        ...
        <div className="text-content">
          ...
          <p>
            View tracks you've recently played with their <br />
            timestamps.
          </p>
        </div>
      </div>
